<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="DeleteBooks.aspx.cs" Inherits="Modify" %>
        ...
        <tr>
            <td><h3>
                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                    Text="Search Book" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ISBN No:&nbsp;&nbsp;&nbsp;</h3></td>
            <td><asp:TextBox ID="textIsbn" runat="server" Width="260px" Font-Size="20px" ></asp:TextBox>
                <asp:Label ID="labelBookError" runat="server" EnableTheming="True" 
                    Font-Size="14px" ForeColor="Red" Text="Enter ISBN number."></asp:Label>
            </td>
        </tr>
        <tr>
            <td><h3>Title:&nbsp;&nbsp;&nbsp;</h3></td>
        ...
        <tr>
            ...
            <td>
                &nbsp;&nbsp;
               <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/cancel.PNG" 
